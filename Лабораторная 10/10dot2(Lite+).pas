...
VAR
  Ch1, Ch2, Ch3, Ch4, Ch5, Ch6, Ch7, Ch8, Ch9, CheckBeg, CheckKavich9, CheckKavich5: CHAR;
BEGIN  {Format}
  Ch1 := ' ';
  Ch2 := ' ';
  Ch3 := ' ';
    ...
    BEGIN
      ...
      DO
        BEGIN {цикл} {Вообще задумка такая: сначала выводим символ, потом проверяем, нужно ли сделать абзац или (абзац и несколько пробелов)}
          ...
          Ch8 := Ch9;
          READ(Ch9);
          IF (Ch9 = ' ') AND (CheckKavich9 = 'N'){избавляемся от пробелов в тех случаях, когда находимся не в кавычках} 
          THEN 
            BEGIN 
              WHILE Ch9 = ' ' 
              DO 
                READ(Ch9) 
             END;    
          IF Ch9 = ''''{проверяем, в кавычках Ch9 или нет}
          THEN
            IF CheckKavich9 = 'N'
            THEN
              CheckKavich9 := 'Y'
